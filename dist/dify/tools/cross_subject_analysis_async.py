"""cross_subject_analysis_async 工具（v1.0.1 G8 自动生成）：经 infoseek REST 桥 POST /tools/cross_subject_analysis_async 调用。"""
...
class CrossSubjectAnalysisAsyncTool(Tool, BaseRemoteTool):
    TOOL_NAME = 'cross_subject_analysis_async'
