"""score_contradiction_async 工具（v1.0.1 G8 自动生成）：经 infoseek REST 桥 POST /tools/score_contradiction_async 调用。"""
...
class ScoreContradictionAsyncTool(Tool, BaseRemoteTool):
    TOOL_NAME = 'score_contradiction_async'
