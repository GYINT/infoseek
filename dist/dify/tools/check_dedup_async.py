"""check_dedup_async 工具（v1.0.1 G8 自动生成）：经 infoseek REST 桥 POST /tools/check_dedup_async 调用。"""
...
class CheckDedupAsyncTool(Tool, BaseRemoteTool):
    TOOL_NAME = 'check_dedup_async'
