"""dedup_stats_async 工具（v1.0.1 G8 自动生成）：经 infoseek REST 桥 POST /tools/dedup_stats_async 调用。"""
...
class DedupStatsAsyncTool(Tool, BaseRemoteTool):
    TOOL_NAME = 'dedup_stats_async'
