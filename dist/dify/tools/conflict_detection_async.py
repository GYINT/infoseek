"""conflict_detection_async 工具（v1.0.1 G8 自动生成）：经 infoseek REST 桥 POST /tools/conflict_detection_async 调用。"""
...
class ConflictDetectionAsyncTool(Tool, BaseRemoteTool):
    TOOL_NAME = 'conflict_detection_async'
