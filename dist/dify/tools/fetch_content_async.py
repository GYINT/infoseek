"""fetch_content_async 工具（v1.0.1 G8 自动生成）：经 infoseek REST 桥 POST /tools/fetch_content_async 调用。"""
...
class FetchContentAsyncTool(Tool, BaseRemoteTool):
    TOOL_NAME = 'fetch_content_async'
