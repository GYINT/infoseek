"""save_archive_async 工具（v1.0.1 G8 自动生成）：经 infoseek REST 桥 POST /tools/save_archive_async 调用。"""
...
class SaveArchiveAsyncTool(Tool, BaseRemoteTool):
    TOOL_NAME = 'save_archive_async'
