"""score_source_async 工具（v1.0.1 G8 自动生成）：经 infoseek REST 桥 POST /tools/score_source_async 调用。"""
...
class ScoreSourceAsyncTool(Tool, BaseRemoteTool):
    TOOL_NAME = 'score_source_async'
