"""research_stream 工具（v1.0.1 G8 自动生成）：经 infoseek REST 桥 POST /tools/research_stream 调用。"""
...
class ResearchStreamTool(Tool, BaseRemoteTool):
    TOOL_NAME = 'research_stream'
