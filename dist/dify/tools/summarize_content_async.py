"""summarize_content_async 工具（v1.0.1 G8 自动生成）：经 infoseek REST 桥 POST /tools/summarize_content_async 调用。"""
...
class SummarizeContentAsyncTool(Tool, BaseRemoteTool):
    TOOL_NAME = 'summarize_content_async'
