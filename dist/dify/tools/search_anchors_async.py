"""search_anchors_async 工具（v1.0.1 G8 自动生成）：经 infoseek REST 桥 POST /tools/search_anchors_async 调用。"""
...
class SearchAnchorsAsyncTool(Tool, BaseRemoteTool):
    TOOL_NAME = 'search_anchors_async'
